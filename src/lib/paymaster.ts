...
// Note: SimpleAccount factory address for EntryPoint v0.7 is built into
// permissionless.js (0x91E60e0613810449d098b0b5Ec8b51A0FE8c8985).
// No need to specify factoryAddress — the library defaults are correct.
...
export async function createGaslessClient(signer: LocalAccount) {
  ...
  // factoryAddress omitted — permissionless.js uses the correct default
  // for EntryPoint v0.7: 0x91E60e0613810449d098b0b5Ec8b51A0FE8c8985
